...
function reviewAndCheckout() {
    ...
    if (cart !== null && cart.length > 0) {
        ...
        if (SR !== '') {
            window.location.href = "/" + SR + "/benevity";
        } else {
            window.location.href = "/benevity";
        }
    }
}
...
function customizeLink() {
    if (SR !== '') {
        window.location.href = "/" + SR + "/benevity/order/customize";
    } else {
        window.location.href = "/benevity/order/customize";
    }
}
