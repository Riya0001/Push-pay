...
const URL_ORDER = `${STORE_ENDPOINT}/order`;
const URL_ORGANIZATION_DETAILS =  `${STORE_ENDPOINT}/order/checkout/organization-details`;
const URL_PAYMENT =  `${STORE_ENDPOINT}/order/checkout/payment`;
