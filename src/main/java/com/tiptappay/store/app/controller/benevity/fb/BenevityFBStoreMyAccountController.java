...
import static com.tiptappay.store.app.constant.AppConstants.CookiesConstants.COOKIE_ID_BENEVITY_FB;
...
public class BenevityFBStoreMyAccountController {
    ...
    public String startCollecting() {
        return REDIRECT_BENEVITY_FB_MY_ACCOUNT_SETUP;
    }
    ...
    public String showBenevityMyAccountSetup(HttpServletRequest request,
        ...
        return VIEW_BENEVITY_FB_STORE_MY_ACCOUNT_SETUP_FOR_CREATING_MEMBER;
    }
    ...
    public String postBenevityMyAccountSetup(HttpServletRequest request, HttpServletResponse response, MyAccountDTO myAccountDTO) {
        logger.logInfo("myAccountDTO : " + myAccountDTO);
        ...
        if (customHttpResponse.getResponseCode() == HTTP_RESPONSE_CREATED) {
            ...
            try {
                ...
                return REDIRECT_BENEVITY_FB_MY_ACCOUNT_SETUP_VERIFY;
        ...
        benevityStoreService.writeMyAccountToken(response, myAccountToken, COOKIE_ID_BENEVITY_FB);
        return String.format(REDIRECT_BENEVITY_FB_MY_ACCOUNT_SETUP_ERROR + "?error=%s", errorMessage);
    }
    ...
    public String showBenevityMyAccountSetupVerify(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return VIEW_BENEVITY_FB_STORE_MY_ACCOUNT_SETUP_VERIFY;
    }


    @PostMapping("/my-account-setup/resend-email")
    public String showBenevityMyAccountSetupResendEmail(HttpServletRequest request, HttpServletResponse response) {
    ...
    public String showBenevityMyAccountSetupError(HttpServletRequest request,
        ...
        return VIEW_BENEVITY_FB_STORE_MY_ACCOUNT_SETUP_VERIFY_FAILED;
    }

    @PostMapping("/keep-collecting")
    public String keepCollecting() {
        return REDIRECT_BENEVITY_FB_MY_ACCOUNT;
    }
    ...
    public String showBenevityMyAccount(HttpServletRequest request,
        ...
        return VIEW_BENEVITY_FB_STORE_MY_ACCOUNT_FOR_EMAIL_ENTRY;
    }
