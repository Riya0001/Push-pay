package com.tiptappay.store.app.controller.benevity.fb;
...
import static com.tiptappay.store.app.constant.AppConstants.OrderFormTypes.FORM_TYPE_BENEVITY_FAITH_BASED;
...
@Slf4j
@Controller
@RequestMapping("${stores.benevity.fb.endpoint}")
@RequiredArgsConstructor
public class BenevityFBStoreController {
    ...
    public String showBenevityStorePricing(HttpServletResponse response) {
        benevityStoreService.deleteMyAccountToken(response, COOKIE_ID_BENEVITY_FB);
        return VIEW_BENEVITY_FB_STORE_PRICING;
    }

    @PostMapping("/order")
    public String postBenevityStorePricing() {
        return REDIRECT_BENEVITY_FB_ORDER_CUSTOMIZE;
    }

    @GetMapping("/order/customize")
    public String showBenevityStoreCustomize(HttpServletResponse response) {
        benevityStoreService.deleteMyAccountToken(response, COOKIE_ID_BENEVITY_FB);
        return VIEW_BENEVITY_FB_STORE_CUSTOMIZE;
    }

    @PostMapping("/order/customize")
    public String postBenevityStoreCustomize() {
        return REDIRECT_BENEVITY_FB_ORDER_CART;
    }

    @GetMapping("/order/cart")
    public String showBenevityStoreCart() {
        return VIEW_BENEVITY_FB_STORE_CART;
    }

    @PostMapping("/order/cart")
    public String postBenevityStoreCart() {
        return REDIRECT_BENEVITY_FB_ORDER_CHECKOUT_ORGANIZATION_DETAILS;
    }

    @GetMapping("/order/checkout/organization-details")
    public String showBenevityStoreOrganizationDetails() {
        return VIEW_BENEVITY_FB_STORE_ORGANIZATION_DETAILS;
    }
    ...
    public String postBenevityStoreOrganizationDetails(@RequestParam("cart") String cartJson,
        ...
        return REDIRECT_BENEVITY_FB_ORDER_CHECKOUT_SHIPPING;
    }
    ...
    public String showBenevityStoreShipping(Model model) {
        ...
        return VIEW_BENEVITY_FB_STORE_SHIPPING;
    }
    ...
    public String postBenevityStoreShipping(@RequestParam("cart") String cartJson,
        ...
        Payload payload = benevityStoreService.preparePayload(FORM_TYPE_BENEVITY_FAITH_BASED, null, checkoutData, cartData, null, ACTION_QUOTE_TAX_AND_SHIPPING);
        ...
        try {
            ...
            cookieService.writeCookie(response, COOKIE_RESPONSE_QUOTE_BODY+ COOKIE_ID_BENEVITY_FB, customHttpResponse.getResponseBody());
        ...
        return REDIRECT_BENEVITY_FB_ORDER_CHECKOUT_PAYMENT;
    }
    ...
    public String showBenevityStorePayment(HttpServletRequest request,
        ...
        String responseBody = cookieService.readCookie(request, COOKIE_RESPONSE_QUOTE_BODY+ COOKIE_ID_BENEVITY_FB);
        ...
        return VIEW_BENEVITY_FB_STORE_PAYMENT;
    }
    ...
    public String postBenevityStorePayment(@RequestParam("cart") String cartJson,
        ...
        Payload payload = benevityStoreService.preparePayload(FORM_TYPE_BENEVITY_FAITH_BASED, null, checkoutData, cartData, paymentData, ACTION_COMPLETE_ORDER_WITH_PAYMENT);
...
//        logger.logDebug("completeOrderWithPayment : " + jsonPayload); // Better never log this!
        ...
        try {
            CustomHttpResponse customHttpResponse = oauthService.runApiRequest(jsonPayload);
            cookieService.writeCookie(response, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_FB, customHttpResponse.getResponseBody());
                ...
                if (benevityCause != null) {
                    ...
                    if (organizationResponse != null) { // Organization Newly Created
                        ...
                        if(organizationRequest.getOrganization().getId() != Integer.MIN_VALUE) {
                            ...
                            return VIEW_BENEVITY_FB_STORE_COMPLETE_FAIL;
                        }
                    }
        ...
        benevityStoreService.writeMyAccountToken(response, myAccountToken, COOKIE_ID_BENEVITY_FB);

        return REDIRECT_BENEVITY_FB_ORDER_COMPLETE;
    }
    ...
    public String showBenevityStoreComplete(HttpServletRequest request,
        ...
        String responseBody = cookieService.readCookie(request, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_FB);
        ResponsePayment responsePayment = dataProcessorService.handleResponse(responseBody);

        MyAccountToken myAccountToken = benevityStoreService.readMyAccountToken(request, response, COOKIE_ID_BENEVITY_FB);
        if (!benevityStoreService.validateMyAccountToken(myAccountToken, response, COOKIE_ID_BENEVITY_FB)) {
        ...
        cookieService.deleteCookie(response, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_FB);

        if (benevityStoreService.isValidPayment(responsePayment)) {
            cookieService.deleteCookie(response, COOKIE_RESPONSE_QUOTE_BODY + COOKIE_ID_BENEVITY_FB);

            if (myAccountToken.isPrepSuccess()) {
                return myAccountToken.isNewOrganization()
                        ? VIEW_BENEVITY_FB_STORE_COMPLETE_START_COLLECTING
                        : VIEW_BENEVITY_FB_STORE_COMPLETE_KEEP_COLLECTING;
            }

            return VIEW_BENEVITY_FB_STORE_ORDER_COMPLETE_MY_ACCOUNT_PREP_FAILED;
        }
