...
import static com.tiptappay.store.app.constant.AppConstants.OrderFormTypes.FORM_TYPE_BENEVITY_NONPROFIT;
...
public class BenevityStoreController {
    ...
    public String postBenevityStoreOrganizationDetails(@RequestParam("cart") String cartJson,
        ...
        return REDIRECT_BENEVITY_ORDER_CHECKOUT_SHIPPING;
    }
    ...
    public String showBenevityStoreShipping(Model model) {
        ...
        return VIEW_BENEVITY_STORE_SHIPPING;
    }
    ...
    public String postBenevityStoreShipping(@RequestParam("cart") String cartJson,
        ...
        Payload payload = benevityStoreService.preparePayload(FORM_TYPE_BENEVITY_NONPROFIT, null, checkoutData, cartData, null, ACTION_QUOTE_TAX_AND_SHIPPING);
        ...
        try {
            ...
            cookieService.writeCookie(response, COOKIE_RESPONSE_QUOTE_BODY + COOKIE_ID_BENEVITY_MAIN, customHttpResponse.getResponseBody());
        ...
        return REDIRECT_BENEVITY_ORDER_CHECKOUT_PAYMENT;
    }
    ...
    public String showBenevityStorePayment(HttpServletRequest request,
        ...
        String responseBody = cookieService.readCookie(request, COOKIE_RESPONSE_QUOTE_BODY + COOKIE_ID_BENEVITY_MAIN);
        ...
        return VIEW_BENEVITY_STORE_PAYMENT;
    }
    ...
    public String postBenevityStorePayment(@RequestParam("cart") String cartJson,
        ...
        Payload payload = benevityStoreService.preparePayload(FORM_TYPE_BENEVITY_NONPROFIT, null, checkoutData, cartData, paymentData, ACTION_COMPLETE_ORDER_WITH_PAYMENT);
...
//        logger.logDebug("completeOrderWithPayment : " + jsonPayload); // Better never log this!
        ...
        try {
            CustomHttpResponse customHttpResponse = oauthService.runApiRequest(jsonPayload);
            cookieService.writeCookie(response, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_MAIN, customHttpResponse.getResponseBody());
                ...
                if (benevityCause != null) {
                    ...
                    if (organizationResponse != null) { // Organization Newly Created
                        ...
                        if (organizationRequest.getOrganization().getId() != Integer.MIN_VALUE) {
                            ...
                            return VIEW_BENEVITY_STORE_COMPLETE_FAIL;
                        }
                    }
        ...
        return REDIRECT_BENEVITY_ORDER_COMPLETE;
    }
    ...
    public String showBenevityStoreComplete(HttpServletRequest request,
        ...
        String responseBody = cookieService.readCookie(request, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_MAIN);
        ...
        cookieService.deleteCookie(response, COOKIE_RESPONSE_PAYMENT_BODY + COOKIE_ID_BENEVITY_MAIN);

        if (benevityStoreService.isValidPayment(responsePayment)) {
            cookieService.deleteCookie(response, COOKIE_RESPONSE_QUOTE_BODY + COOKIE_ID_BENEVITY_MAIN);

            if (myAccountToken.isPrepSuccess()) {
                return myAccountToken.isNewOrganization()
                        ? VIEW_BENEVITY_STORE_COMPLETE_START_COLLECTING
                        : VIEW_BENEVITY_STORE_COMPLETE_KEEP_COLLECTING;
            }

            return VIEW_BENEVITY_ORDER_COMPLETE_MY_ACCOUNT_PREP_FAILED;
        }
