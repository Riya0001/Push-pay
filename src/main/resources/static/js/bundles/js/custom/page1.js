...
const plansMonthly = [
    {
        ...
        subtitle: "Campaign Monthly Rental",
        currencySymbol: "$",
        price: "519",
        pricePeriod: "First month",
        pricePeriodExp: "(then $105 / month)",
        description: "Triple the Coverage, Monthly Convenience",
        mostPopular: false,
        separator: " ",
        moreDetails: {
            contentOne: {
                title: "What you get:",
                list: [
                    "3 tiptap Devices (Choose between $5, $10, $20, and $50 denominations)",
                    "Floor Stand with Steel Base or Large Counter Display",
                    "Wall Plug and Cable",
                    "Standard Signage",
            ...
            contentTwo: {
                title: "Additional Bundle Discount:",
                list: [
                    "$319 First month (then $105 / month)*",
                ],
            }
        },
        default: {
    ...
    },
    {
        ...
        pricePeriod: "month",
        pricePeriodExp: "x 6",
        description: "Half a Year, Three Devices, Full Flexibility",
        mostPopular: false,
        separator: "/",
        moreDetails: {
            contentOne: {
    ...
    },
    {
        ...
        pricePeriod: "month",
        pricePeriodExp: "x 12",
        description: "One Year, Three Devices, Maximum Savings",
        mostPopular: true, // Most Popular Plan
        separator: "/",
        moreDetails: {
            contentOne: {
                title: "What you get:",
    ...
    },
    {
        ...
        price: "339",
        pricePeriod: "First month",
        pricePeriodExp: "(then $35 / month)",
        description: "One Device, Monthly Flexibility",
        mostPopular: false,
        separator: " ",
        moreDetails: {
            contentOne: {
                title: "What you get:",
                list: [
                    "1 tiptap Device (Choose between $5, $10, $20, and $50 denominations)",
                    "Mobile Mini CLip or Medium Counter Display",
                    "Wall Plug, Cable and Battery",
                    "Standard Signage",
                    "All Setup and Activation Fees"
                ],
            },
    ...
    },
    {
        ...
        pricePeriod: "month",
        pricePeriodExp: "x 6",
        description: "Half a Year of One Device, Hassle-Free",
        mostPopular: false,
        separator: "/",
        moreDetails: {
            contentOne: {
    ...
    },
    {
        ...
        pricePeriod: "month",
        pricePeriodExp: "x 12",
        description: "One Year, One Device, Ultimate Value",
        mostPopular: false,
        separator: "/",
        moreDetails: {
            contentOne: {
...
<path d="M13.1668 8.0004C13.0658 8.00037 12.9671 7.96972 12.8838 7.91248C12.8005 7.85524 12.7365 7.77411 12.7002 7.67978L11.9865 5.82446C11.9739 5.79177 11.9547 5.76208 11.9299 5.73732C11.9051 5.71255 11.8754 5.69327 11.8427 5.68071L9.98744 4.96696C9.89318 4.93064 9.81213 4.86663 9.75497 4.78334C9.69781 4.70006 9.66721 4.60142 9.66721 4.5004C9.66721 4.39939 9.69781 4.30074 9.75497 4.21746C9.81213 4.13418 9.89318 4.07016 9.98744 4.03384L11.8427 3.32009C11.8754 3.30753 11.9051 3.28825 11.9299 3.26349C11.9547 3.23872 11.9739 3.20903 11.9865 3.17634L12.6949 1.33415C12.7273 1.24704 12.7826 1.17032 12.8551 1.11215C12.9276 1.05399 13.0144 1.01656 13.1065 1.00384C13.2171 0.99045 13.329 1.01439 13.4245 1.07185C13.5199 1.12931 13.5934 1.21701 13.6334 1.32103L14.3471 3.17634C14.3597 3.20903 14.379 3.23872 14.4037 3.26349C14.4285 3.28825 14.4582 3.30753 14.4909 3.32009L16.3462 4.03384C16.4404 4.07016 16.5215 4.13418 16.5787 4.21746C16.6358 4.30074 16.6664 4.39939 16.6664 4.5004C16.6664 4.60142 16.6358 4.70006 16.5787 4.78334C16.5215 4.86663 16.4404 4.93064 16.3462 4.96696L14.4909 5.68071C14.4582 5.69327 14.4285 5.71255 14.4037 5.73732C14.379 5.76208 14.3597 5.79177 14.3471 5.82446L13.6334 7.67978C13.5971 7.77411 13.5331 7.85524 13.4498 7.91248C13.3665 7.96972 13.2679 8.00037 13.1668 8.0004Z" fill="white"/>
        ...
        <div class="card-body">
            ...
            <div style="margin-bottom: 10px;"><span class="h3 text-black fw-bold">${plan.currencySymbol + plan.price}</span><span class="text-muted"> ${plan.separator} ${plan.pricePeriod} ${plan.pricePeriodExp}</span></div>
            <strong>Additional Bundle Discount:</strong> ${contentTwo}
            <a href="#" class="btn ttp-btn-primary mt-3 w-100" data-bs-toggle="collapse" data-bs-target="#collapseDetails${index}" aria-expanded="false" aria-controls="collapseDetails${index}" onclick="onNext(${index})">Get Started</a>

            <div class="accordion" id="accordionExample">
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordionButton accordion-button collapsed text-muted small" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" onclick="changeText()" >
                            View More Details                    
                        </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample" style="">
                            <div class="accordion-body">
                            <div style="font-size: 14px; font-weight: bold">${plan.moreDetails.contentOne.title}</div>
                            <table class="table table-borderless" style="margin-bottom: 0">
                                <tbody>
                                    ${contentOne}
                                </tbody>
                            </table>
                            <div style="text-align: left; padding-top: 25px; color: #18181B;">
  <p style="font-size: 14px;">IMPORTANT: tiptap is not a payment processor.</p>
  <strong style="font-size: 18px;">What you need to get:</strong>

  <div style="margin-top: 10px;">
    <div style="display: flex; align-items: center; margin-top: 8px;">
      <svg width="14" height="14" viewBox="0 0 19 16" xmlns="http://www.w3.org/2000/svg" style="margin-right: 15px;flex-shrink: 0;margin-left: 8px;">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M18.6226 1.90211L6.71762 15.5078L0.708984 9.49912L2.16739 8.04072L6.61716 12.4905L17.0704 0.543945L18.6226 1.90211Z" fill="#1D4ED8" style="
    margin-left: 10px;
"></path>
      </svg>
      <span style="font-size: 14px;">A payment processing account is required to connect your devices to your bank account.</span>
    </div>
...
"></path>
      ...
      <span style="font-size: 14px;">A link to connect with a payment processor will be issued after your order is submitted.</span>
    </div>
  </div>
</div>

<div style="text-align: left; padding-top: 25px; color: #18181B;">
  <strong style="font-size: 18px;">Associated Fees:</strong>
  <p style="font-size: 14px;">Fees vary by payment processor, averaging about 3.50%–3.65% plus $0.10–$0.20 per transaction.</p>
</div>
