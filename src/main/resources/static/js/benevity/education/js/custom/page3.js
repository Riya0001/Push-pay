...
function reviewAndCheckout() {
    ...
    if (cart !== null && cart.length > 0) {
        ...
        if (SR !== '') {
            window.location.href = "/" + SR + "/benevity/education";
        } else {
            window.location.href = "/benevity/education";
        }
    }
}
...
function customizeLink() {
    if (SR !== '') {
        window.location.href = "/" + SR + "/benevity/education/order/customize";
    } else {
        window.location.href = "/benevity/education/order/customize";
    }
}
